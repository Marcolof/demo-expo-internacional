 ...
 * §8.3 "Código telefónico de país"). Subconjunto para la maqueta.
 *
 * `isoCode` (ISO 3166-1 alpha-2) selecciona la bandera de `country-flag-icons`
 * en `PhoneCountryCodeSelect`. En Windows no existen emoji de bandera, por eso
 * se usa la librería de SVGs en vez de glifos de emoji.
 */
