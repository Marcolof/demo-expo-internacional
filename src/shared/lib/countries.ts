...
/**
 * Listado estándar de países (ISO 3166-1 alpha-2), en español, orden
 * alfabético. No es una maqueta acotada: es el universo real de países que
 * un selector de destino debería poder ofrecer.
 *
 * Argentina queda afuera a propósito: esta lista se usa para destinos de
 * envíos internacionales SALIENTES desde Argentina, así que el propio país
 * de origen no es una opción válida.
 */
